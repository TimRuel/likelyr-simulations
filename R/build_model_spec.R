...
# ============================================================
# 3. Read simulation config
# ============================================================
config <- read_yaml(sim_config_path)

# ============================================================
# 4. Resolve simulation data directory from config
# ============================================================
...
# ============================================================
# 6. Source model specs into isolated environment
# ============================================================
spec_env <- likelyr:::load_spec_env(specs_dir)

# ============================================================
# 7. Validate required factory functions
# ============================================================
required_fns <- c(
  "make_parameter",
  "make_likelihood",
...
# ============================================================
# 9. Assemble model_spec (STRUCTURE ONLY)
# ============================================================
model <- model_spec(
  name = sprintf(
    "%s — %s / %s",
